			...
			<section class="scrollable padder">
				...
				<section class="panel panel-default">
					...
					<div class="row text-sm wrapper">
						<form class="form-inline" name="searchform" action="<?php echo pfUrl('','operate','development');?>" method="GET" style="margin-left:15px;">
							<input type="hidden" value="operate" name="c"> <input type="hidden" value="development" name="a"> <input type="hidden" name="s" value="is_post" />
								...
								<a class="btn btn-sm btn-default" href="<?php echo pfUrl('','operate','development');?>" style="white-space:nowrap;">重置</a>
