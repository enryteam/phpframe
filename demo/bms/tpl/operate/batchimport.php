		...
		<section class="vbox">
			<section class="scrollable padder">
				<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
					...
					<li><a href="javascript:;">批量开户</a></li>
				</ul>
					...
					<div class="col-sm-6">
						<div class="w_98 edit_box">
							<section class="panel panel-default">
								<header class="panel-heading"> <strong>批量开户</strong> </header>
								<form action="<?php echo pfurl('','operate','batchimport');?>" method="post"  enctype="multipart/form-data" class="form-horizontal">
									<div class="edit_cont">
										<div class="cbox">
													...
													<div class="col-sm-10">
														...
														<div class="bootstrap-filestyle" style="display: inline;">
															<label class="btn btn-default">
																<span onclick="javascript:window.location.href='../attms/yykaihu.xls'">下载模板</span>
															</label>
