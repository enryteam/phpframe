			...
			<section class="scrollable padder">
				...
				<section class="panel panel-default">
					...
					<div class="row text-sm wrapper">
						<form class="form-inline" name="searchform" action="<?php echo pfUrl('','agent_operation','development');?>" method="GET" style="margin-left:15px;">
							<input type="hidden" value="agent_operation" name="c"> <input type="hidden" value="development" name="a"> <input type="hidden" name="s" value="is_post" />
								...
								<a class="btn btn-sm btn-default" href="<?php echo pfUrl('','agent_operation','development');?>" style="white-space:nowrap;">重置</a>
							...
							<tbody role="alert" aria-live="polite" aria-relevant="all">
								<?php if(!empty($res)){foreach($res as $key=>$vo){?>
									<tr>
										...
										<td><a href="index.php?c=agent_operation&a=detail&referral_code=<?php echo $vo["referral_code"]?>">查看发展客户</a></td>
									</tr>
								<?php }}else{?>
									<tr>
