							...
							<div class="col-sm-6">
								<div class="w_98 edit_box">
									<section class="panel panel-default">
										<header class="panel-heading"> <strong>商品分类新增</strong> </header>
										<form action="<?php echo pfurl('','goods_cate','add');?>" class="form-horizontal" method="post" >
												...
												<div class="cbox">
													<div class="panel-body">
														<div class="form-group">
															...
															<div class="col-sm-9">
																<input type="text" name="title" class="form-control" value="" placeholder="商品分类名称">
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																...
																<input type="hidden" name="img" value="" id="my_avatar_touxiang" />
															</div>
														</div>
														<div class="line line-dashed line-lg pull-in"></div>
														<div class="form-group">
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<div class="radio" style="float:left;margin-right:25px;">
																	<label>
																	  <input type="radio" name="status" value="1" >是 </label>
																</div>
																<div class="radio" style="float:left;">
																	<label>
																	<input type="radio" name="status" value="0" >否 </label>
																</div>
															</div>
														</div>
													</div>
