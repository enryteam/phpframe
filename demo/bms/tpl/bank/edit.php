					...
					<div class="col-sm-6">
						<div class="w_98 edit_box">
							<section class="panel panel-default">
								<header class="panel-heading"> <strong>银行编辑</strong> </header>
								<form action="<?php echo pfurl('','bank','edit');?>" method="post" class="form-horizontal">
										...
										<div class="cbox">
											<div class="panel-body">
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input type="text" name="title" class="form-control" value="<?php echo $bank['title'];?>">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input type="text" name="code" class="form-control" value="<?php echo $bank['code'];?>">
													</div>
												</div>
												<div class="line line-dashed line-lg pull-in"></div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<img src="<?php echo $bank['image'];?>" class="moren_tou" width="80px;" style="margin-bottom:10px;border:1px solid #dfdfdf;"/><input type="file" name="name" value="" onChange="change_touxiang()" id="scflie_morentou">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="radio" style="float:left;margin-right:25px;">
															<label>
																<input type="radio" name="status" <?php if($bank['status']==1) echo 'checked';?> value="1">储蓄卡 </label>
														</div>
														<div class="radio" style="float:left;">
															<label>
																<input type="radio" name="status" <?php if($bank['status']==2) echo 'checked';?> value="2">信用卡 </label>
														</div>
														<div class="radio" style="float:left;">
															<label>
																<input type="radio" name="status" <?php if($bank['status']==3) echo 'checked';?> value="3">全部 </label>
														</div>
													</div>
												</div>
											</div>  
