				...
				<section class="vbox">
					<section class="scrollable padder">
						<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
							...
							<li><a>商品管理</a></li>
							<li><a href='javascript:;'>商品审核</a></li>
						</ul>
						<div class="row">
							<div class="col-sm-6">
								<div class="w_98 edit_box">
									<section class="panel panel-default">
										<header class="panel-heading"> <strong>商品审核</strong> </header>
												...
												<div class="cbox">
													<div class="panel-body">
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<input type="text" name="mechanism" class="form-control" placeholder="<?php echo $detail['mechanism'];?>" disabled>
															</div>
														</div>
														<div class="line line-dashed line-lg pull-in"></div>
														<div class="form-group">
															...
															<div class="col-sm-9">
																<a href="<?php echo $detail['license'];?>"><img src="<?php echo $detail['license'];?>"></a>
															</div>
														</div>
														<div class="line line-dashed line-lg pull-in"></div>
														<div class="form-group">
															...
															<div class="col-sm-9">
																<a href="<?php echo $detail['img'];?>"><img src="<?php echo $detail['img'];?>"></a>
															</div>
														</div>
														<div class="line line-dashed line-lg pull-in"></div>
														<div class="form-group">
														...
														<div class="line line-dashed line-lg pull-in"></div>
														<div class="form-group">
															<label class="col-sm-3 control-label">自然人姓名</label>
															<div class="col-sm-9">
														...
														<div class="line line-dashed line-lg pull-in"></div>
														<div class="form-group">
															<label class="col-sm-3 control-label">自然人身份证号</label>
															<div class="col-sm-9">
																<input type="text" name="natural_idcard" class="form-control" placeholder="<?php echo strlen($vo["natural_idcard"])==15?substr_replace($vo["natural_idcard"],"********",6,8):(strlen($vo["natural_idcard"])==18?substr_replace($vo["natural_idcard"],"********",6,8):"身份证位数不正常！");?>" disabled>
															</div>
														</div>
														<div class="line line-dashed line-lg pull-in"></div>
														<div class="form-group">
															<label class="col-sm-3 control-label">自然人联系电话</label>
															<div class="col-sm-9">
