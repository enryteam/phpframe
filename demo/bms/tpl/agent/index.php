		...
		<section class="vbox">
			<section class="scrollable padder">
				<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
					...
					<li><a href="javascript:;">代理商编辑</a></li>
				</ul>
				...
				<section class="panel panel-default">
					...
					<div class="row text-sm wrapper">
						<form class="form-inline" name="searchform" action="<?php echo pfUrl('','agent','index');?>" method="GET" style="margin-left:15px;">
							<input type="hidden" value="agent" name="c"> <input type="hidden" value="index" name="a"> <input type="hidden" name="s" value="is_post" />
								...
								<a class="btn btn-sm btn-default" href="<?php echo pfUrl('','agent','index');?>" style="white-space:nowrap;">重置</a>
									...
									<tr>
										...
										<td>
											<div align="center" style="white-space:nowrap;">
												<a class='btn_change' href="<?php echo pfUrl(" ","agent","edit",array("id"=>$vo['id']))?>" style="white-space:nowrap;">编辑</a>
												<a class='btn_del' href="<?php echo pfUrl(" ","agent","del_freeze",array("id"=>$vo['id']))?>" style="white-space:nowrap;">删除</a>
