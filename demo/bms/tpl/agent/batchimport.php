					...
					<div class="col-sm-6">
						<div class="w_98 edit_box">
							<section class="panel panel-default">
								...
								<form action="<?php echo pfurl('','agent','batchimport');?>" method="post"  enctype="multipart/form-data" class="form-horizontal">
									<div class="edit_cont">
										<div class="cbox">
													...
													<div class="col-sm-10">
														...
														<div class="bootstrap-filestyle" style="display: inline;">
															<label class="btn btn-default">
																<span onclick="javascript:window.location.href='../attms/dlskaihu.xls'">下载模板</span>
															</label>
