					...
					<div class="col-sm-6">
						<div class="w_98 edit_box">
							<section class="panel panel-default">
								<header class="panel-heading"> <strong>文章编辑</strong> </header>
								<form action="<?php echo pfurl('','article','edit');?>" method="post" class="form-horizontal">
											...
											<div class="panel-body">
													...
													<div class="col-sm-9">
														<select name="cateid" class="input-sm form-control input-s-sm inline cateid">
															...
															<?php foreach($cate as $k=>$v){?>
																<option value="<?php echo $v["id"];?>" <?php if($detail['cateid'] == $v["id"]) echo 'selected';?>><?php echo $v["title"];?></option>
															<?php }?>
														</select>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														...
														<script id="ueditor" type="text/plain" style="width:800px;height:400px;" name="content"><?php echo $detail['content'];?></script>
