		...
		<section class="vbox">
			<section class="scrollable padder">
				...
				<section class="panel panel-default">
					<header class="panel-heading"> 成交记录 </header>
					<div class="row text-sm wrapper">
						<form class="form-inline" name="searchform" action="<?php echo pfUrl('','deal','index');?>" method="GET" style="margin-left:15px;">
							<input type="hidden" value="deal" name="c"> <input type="hidden" value="index" name="a"> <input type="hidden" name="s" value="is_post" />
								...
								<a class="btn btn-sm btn-default" href="<?php echo pfUrl('','deal','index');?>" style="white-space:nowrap;">重置</a>
