	...
	<div class="right_celan">
		<?php if(empty($userdata['head_img'])){?>
			<img src="../attms/images/user.png" class="img1" style="width:18px;height:19px;" onClick="javascript:window.location.href='../acenter/index.php?c=index&a=index';"/>
		<?php }else{?>
			<img src="<?php echo $userdata['head_img'];?>" class="img1" style="width:18px;height:19px;" onClick="javascript:window.location.href='../acenter/index.php?c=index&a=index';"/>
		<?php }?>
		<div onclick="shopcar('<?php echo $userdata['realname'];?>')">
			<img src="../attms/images/right_shop_car.png" class="img2" />
			<i>购物车</i>
			<b id="end"><?php echo intval($shopcar);?></b>
		</div>
		...
		<div class="inside-wrap">
			<div class="topbar-left">
				<div class="small-signin">
					<span><?php echo empty($userdata['phone'])?"<a href='../acenter/index.php?c=index&a=login'>登录</a><a href='../portal/index.php?c=barclays&a=register' rel='nofollow'>申请开户</a>":'<span style="color:#e03e3f;cursor: pointer;" onclick="ucenter()" >'.$userdata['phone'].'&nbsp;&nbsp;&nbsp;</span><a href="javascript:" rel="nofollow" onclick="back()">退出</a>';?></span>
				</div>
			</div>
			<div class="topbar-right">
				<div class="subnav">
					<div class="right-link clearfix">
						<div class="xj-helpcenter-top"><a href="../acenter/index.php?c=index&a=index"><?php if($userdata['type'] == 0) echo "用户中心";elseif($userdata['type'] == 2) echo "运营中心";elseif($userdata['type'] == 3) echo "代理运营中心";elseif($userdata['type'] == 4) echo "代理商中心";elseif($userdata['type'] == 1) echo "交易商中心";?> <img src="../attms/images/down.png" alt="" style="position:relative;top:-2px;"/> </a></div>
						<!--<div class="xj-helpcenter-top"><a href="javascript:;" onclick="javascript:role(<?php echo $userdata['role']?>);">我是交易商</a></div>-->
						<div class="xj-helpcenter-top"><a href="index.php?c=index&a=index">网站首页</a></div>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="page-header page-header-bg">
		<div class="inner-wrap clearfix">
			<div class="header-left">
				<h1><a href="index.php?c=index&a=index"><img src="../attms/images/logo.png" alt=""></a></h1>
			</div>
			<div class="header-right">
				<div class="searchbar">
					<form action="index.php?#anchor" method="post" async="false">
						<select style="cursor:pointer;color:#666666;position:absolute;height:37px;line-height:37px;width:65px;padding-right:5px;padding-left:12px;border:0;background:transparent url('../attms/images/down.png') no-repeat scroll 50px center;-moz-appearance: none;" id="headertype"><option>代码</option><option>名称</option></select>
			...
			<div class="header-main">
				<a href="javascript:;" onclick="shopcar('<?php echo $userdata['realname'];?>')">
					...
					<i id="shopcar"><?php echo intval($shopcar);?></i>
				</a>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		{
			if(value == 1){
				window.location.href="index.php?c=entry_market&a=entry_apply";
			}else{
