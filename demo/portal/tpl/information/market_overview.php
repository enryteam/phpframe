...
<title>市场综述 积交所 jjs.51daniu.cn</title>
...
<body>
  ...
  <div class="portal_deal_center">
    <h1>您现在的位置： <a href="portal_index.html">积交所</a>&nbsp;&gt;&gt;&nbsp;<a href="javascript:;">市场综述</a></h1>
    <div class="center" style="margin-top:0;">
        <div class="left">
            <div class="top">
                <h1><i></i>市场综述</h1>
                <dl>
				<?php if(!empty($market_overview)){foreach($market_overview as $k=>$v){?>
					<dt>
						<div class="left">
						...
						<div class="right">
							...
							<h2><?php echo mb_substr(strip_tags($v["content"]),0,80,'utf-8');?><i style="cursor:pointer;" onclick="javascript:detail('<?php echo $v['id']?>','<?php echo $v['cateid'];?>');">[详细]</i></h2>
...
<script type="text/javascript">
	...
	{
		window.location.href="index.php?c=information&a=detail&id="+id+"&cateid="+cateid+"&remark=市场综述";
	}
