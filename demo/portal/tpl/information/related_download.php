...
<title>相关下载 积交所 jjs.51daniu.cn</title>
...
<body>
	...
	<div class="portal_deal_center">
		<h1>您现在的位置： <a href="portal_index.html">积交所</a>&nbsp;&gt;&gt;&nbsp;<a href="javascript:;">相关下载</a></h1>
		<div class="center" style="margin-top:0;">
			<div class="left">
				<div class="top">
					<h1><i></i>相关下载</h1>
					<dl>
					<?php if(!empty($related_download)){foreach($related_download as $k=>$v){?>
						<dt>
							<div class="left">
							...
							<div class="right">
								...
								<h2><?php echo mb_substr(strip_tags($v["content"]),0,80,'utf-8');?> <i style="cursor:pointer;" onclick="javascript:window.location.href='<?php echo $v['link'];?>'">[点击下载]</i></h2>
...
<script type="text/javascript">
	...
	{
		window.location.href="index.php?c=information&a=detail&id="+id+"&cateid="+cateid+"&remark=相关下载";
	}
