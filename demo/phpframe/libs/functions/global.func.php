    ...
    if ($num > $perpage) {
        ...
        if ($curr_page > 0) {
            if ($curr_page == 1) {
                ...
                $multipage .= " <a href='" . pageurl($urlrule, $curr_page - 1, $array) . "'>上一页</a>  <a href='" . pageurl($urlrule, 1, $array) . "'>1</a> ";
            }
        }
        for ($i = $from; $i <= $to; $i ++) {
            if ($i != $curr_page) {
        ...
        if ($curr_page < $pages) {
            ...
            if ($curr_page < $pages - 5 && $more) {
                ...
                $multipage .= "<a href='javascript:;'>...</a><a href='" . pageurl($urlrule, $pages, $array) . "'>" . $pages . "</a><a href='" . pageurl($urlrule, $curr_page + 1, $array) . "'>下一页</a>";
            } else {
			
               $multipage .= " <a href='" . pageurl($urlrule, $pages, $array) . "'>" . $pages . "</a>  <a href='" . pageurl($urlrule, $curr_page + 1, $array) . "'>下一页</a> ";
            }
        } elseif ($curr_page == $pages) {
            $multipage .= "  <a href='javascript:;'>" . $pages . "</a> <a href='javascript:;'>下一页</a> ";
        } else {
            $multipage .= " <a href='" . pageurl($urlrule, $pages, $array) . "'>" . $pages . "</a>  <a href='" . pageurl($urlrule, $curr_page + 1, $array) . "'>下一页</a> ";
        }
    }
    $multipage = "<a href='###'>共".$num."条记录</a>  ".$multipage."";
    return $multipage;
