...
$LANG['domain_name_format'] = '域名可为空，格式应该为http://www.local/';
$LANG['domain_end_string'] = '格式应该为http://www.local/，请以‘/’结束';
...
$LANG['site_domain_ex'] = '请填写域名，格式为：http://www.local/';
$LANG['site_domain_ex2'] = '格式应该为http://www.local/，请以‘/’结束';
